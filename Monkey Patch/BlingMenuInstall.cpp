...
// probably could just keep it as true but for safety we'll reset to false.
   ...
   void AddOptions() {
       ...
       BlingMenuAddBool("Juiced", "b_train_havok_frametime_extra_fix", &Game::b_train_havok_frametime_extra_fix, NULL);
       ...
       BlingMenuAddFloat("Juiced Debug", "Render Distance", (float*)0x00E996B4, []() {
           Render3D::RenderDistance_old = *(float*)0x00E996B4;
           }, 0.65f, 1.f, 500.f);
